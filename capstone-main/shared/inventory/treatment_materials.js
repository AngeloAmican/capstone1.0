(() => {
  ...
  const treatmentMaterials = {
    ...
    "dental whitening": [
      { names: ["Fluoride Gel", "Fluoride Varnish", "Fluoride Foam"], quantity: 1 },
      { names: ["Cotton Rolls"], quantity: 1 },
    ],
    "dental filling": [
      { names: ["Composite Resin", "Composite Resins"], quantity: 1 },
      { names: ["Etching Gel"], quantity: 1 },
      { names: ["Dental Bonding Agent", "Bonding Agent", "Universal Bond"], quantity: 1 },
    ...
    "tooth extraction": [
      ...
      { names: ["Cotton Rolls"], quantity: 1 },
      { names: ["Disposable Gloves", "Nitrile Gloves", "Latex Gloves"], quantity: 1 },
    ],
